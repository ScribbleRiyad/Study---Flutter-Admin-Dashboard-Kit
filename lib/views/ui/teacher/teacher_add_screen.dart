...
import 'package:study/controller/ui/teacher/teacher_add_contorller.dart';
...
class _TeacherAddScreenState extends State<TeacherAddScreen>
  ...
  late TeacherAddController controller;

  @override
  void initState() {
    controller = Get.put(TeacherAddController());
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(name: 'Add Teacher', active: true),
                      ],
                    ),
                  ],
                ),
                        ...
                        MyFlexItem(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                MySpacing.height(12),
                                buildTextField("Education", "Enter Education"),
                                MySpacing.height(12),
                                MyText.labelMedium(
                                  "DOB",
                                ),
