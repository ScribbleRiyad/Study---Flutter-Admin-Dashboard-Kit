...
import 'package:study/controller/ui/organization/organization_edit_controller.dart';
...
class _OrganizationEditScreenState extends State<OrganizationEditScreen>
  ...
  late OrganizationEditController controller;

  @override
  void initState() {
    controller = Get.put(OrganizationEditController());
    super.initState();
  }
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(
                            name: 'Add Organization', active: true),
                      ],
                    ),
                  ],
                ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                buildTextField(
                                    ...
                                    'Number of courses',
                                    controller.basicValidator
                                        .getController('number_of_courses')),
                                MySpacing.height(16),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
