...
import 'package:study/controller/ui/organization/organization_add_controller.dart';
...
class OrganizationAddScreen extends StatefulWidget {
  const OrganizationAddScreen({super.key});
...
class _OrganizationAddScreenState extends State<OrganizationAddScreen>
  ...
  late OrganizationAddController controller;

  @override
  void initState() {
    controller = Get.put(OrganizationAddController());
    super.initState();
  }
